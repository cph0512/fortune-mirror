...
### 紫微斗數命盤判讀規則：
1. 紫微命盤是 4×3 共12格的方陣，每格代表一個宮位
2. **逐格判讀**：從命宮開始，順時針（或依圖片排列）逐一讀取每一宮
3. 每宮必須讀取：宮位名稱、主星（甲級星）、輔星（乙級星）、煞星、四化標記（祿權科忌）
4. **不要猜測**：如果某個字看不清楚，標記為「不確定」，不要亂填
5. 注意區分容易混淆的星曜：廉貞/貪狼、天機/天梁、武曲/破軍等
6. 四化（化祿、化權、化科、化忌）通常標記在星曜旁邊，用小字或符號表示
